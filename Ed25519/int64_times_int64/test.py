...
def main():
    ...
    for _ in range(100):
        ...
        cmd_compile = ["gcc", "test_generated.c", "int64_times_int64.S", "-o", "test_generated"]
        ...
        if correct_result == val_128:
            ...
            asm_str = format_320_hex_grouped(val_128)
            ...
            difference = val_128 - correct_result
