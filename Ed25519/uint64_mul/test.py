...
def unify_limbs_to_uint128(v0,v1):
    """
    Combines four 64-bit unsigned integers into a 256-bit unsigned integer.
...
int main() {{
    ...
    uint64_t A = 0x{A0:016x};
    uint64_t B = 0x{B0:016x};
    uint128_t R = {{ 0 }};
...
def main():
    ...
    for _ in range(1):
        ...
        cmd_compile = ["gcc", "test_generated.c", "uint64_mul.S", "-o", "test_generated"]
        ...
        val_asm = unify_limbs_to_uint128(v0=r0, v1=r1)
